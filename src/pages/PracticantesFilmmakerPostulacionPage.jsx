...
export default function PracticantesFilmmakerPostulacionPage() {
    ...
    <div className="antialiased" style={{ fontFamily:'system-ui,-apple-system,sans-serif', background:'var(--light)' }}>
        ...
        <div style={{ maxWidth:'1200px', margin:'0 auto', padding:'4rem 1.5rem 0' }}>
          <div className="dp-hero-grid">
            <div>
              ...
              <h1 className="dp-hero-title dp-anim dp-anim-d2" style={{ color:'var(--gold)', marginBottom:'1rem' }}>Filmmaker</h1>
              <div className="dp-anim dp-anim-d2" style={{ marginBottom:'1.5rem' }}>
                <span style={{ background:'var(--rose)', color:'var(--black)', fontWeight:700, fontSize:'.8rem', letterSpacing:'.12em', textTransform:'uppercase', padding:'.4rem 1rem', borderRadius:'4px', display:'inline-block' }}>
                  Para estudiantes de Comunicaciones o Cine
                </span>
              </div>
              <p className="dp-anim dp-anim-d3" style={{ color:'rgba(255,255,255,.7)', fontSize:'1.05rem', lineHeight:1.7, marginBottom:'2rem', maxWidth:'480px' }}>
                Buscamos practicantes apasionados por el video y la narrativa visual para crear contenido que inspire en redes sociales y refleje la esencia de DermicaPro.
              </p>
              <div className="dp-anim dp-anim-d3" style={{ display:'flex', flexWrap:'wrap', gap:'1rem', marginBottom:'2.5rem' }}>
                {[{ icon:'🎥', label:'Proyectos reales' },{ icon:'📱', label:'Alcance en redes' },{ icon:'🌱', label:'Portafolio sólido' }].map(b => (
                ...
                <form onSubmit={handleSubmit} noValidate>
                  <div style={{ display:'flex', flexDirection:'column', gap:'1rem' }}>
                    <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'.75rem' }}>
                      {[['nombre','Nombre','Carlos'],['apellido','Apellido','Ramirez']].map(([f,l,p]) => (
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr', gap:'1.5rem' }} className="req-grid">
            <div style={{ background:'var(--white)', borderRadius:16, padding:'2rem', border:'1px solid rgba(0,0,0,.06)', boxShadow:'0 4px 20px rgba(0,0,0,.05)' }}>
              ...
              <ul style={{ listStyle:'none', padding:0, margin:0, display:'flex', flexDirection:'column', gap:'.75rem' }}>
                <CheckItem>Estudiante de Comunicaciones, Artes Visuales, Cine o carrera afín.</CheckItem>
                <CheckItem>Manejo básico de cámara (DSLR, mirrorless o smartphone).</CheckItem>
                <CheckItem>Pasión por contar historias a través del video y el contenido digital.</CheckItem>
                <CheckItem>Disponibilidad mínima de 4 horas diarias para trabajar con el equipo.</CheckItem>
              </ul>
            </div>
            <div style={{ background:'var(--black)', borderRadius:16, padding:'2rem', border:'1px solid rgba(200,161,62,.25)', boxShadow:'0 4px 20px rgba(0,0,0,.12)' }}>
              ...
              <ul style={{ listStyle:'none', padding:0, margin:0, display:'flex', flexDirection:'column', gap:'.75rem' }}>
                {['Ambiente joven, creativo y dinámico que valora tus ideas.','Tus videos llegan a miles de personas en redes reales.','Portafolio sólido con proyectos de una marca en crecimiento.','Capacitación en tendencias de contenido y narrativa de marca.','Experiencia que vale más que cualquier ejercicio universitario.'].map(o => (
      ...
      <section style={{ background:'var(--black)', padding:'5rem 1.5rem', position:'relative', overflow:'hidden' }}>
        ...
        <div style={{ maxWidth:'700px', margin:'0 auto', textAlign:'center', position:'relative' }}>
          ...
          <h2 style={{ fontWeight:900, fontSize:'clamp(2rem,5vw,3rem)', color:'var(--white)', lineHeight:1.1, marginBottom:'.75rem' }}>Construye tu<br /><span style={{ color:'var(--gold)' }}>portafolio con nosotros.</span></h2>
          <p style={{ color:'rgba(255,255,255,.6)', fontSize:'.95rem', lineHeight:1.7, marginBottom:'2rem' }}>Postúlate y cuéntanos tu historia visual. Tu próxima gran experiencia puede estar aquí.</p>
